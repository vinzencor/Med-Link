...
export default function DisplayCards({ cards }: DisplayCardsProps) {
  const defaultCards: DisplayCardProps[] = [
    {
      className:
        "[grid-area:stack] hover:-translate-y-10 before:absolute before:left-0 before:top-0 before:h-[100%] before:w-[100%] before:rounded-xl before:bg-background/50 before:bg-blend-overlay before:outline before:outline-1 before:outline-border before:content-[''] before:grayscale-[100%] before:transition-opacity before:duration-700 hover:before:opacity-0 hover:grayscale-0",
    },
    {
      className:
  ...
  return (
    <div className="grid place-items-center [grid-template-areas:'stack'] animate-in fade-in-0 opacity-100 duration-700">
